...
const Post: React.FC<PostProps> = ({ id, title, contents, thumbnail, createdAt, updatedAt }) => {
  return (
    <div className="shadow-x0_y2_b2_0.1 w-full rounded-[4px] bg-white" onClick={() => console.log(id)}>
      ...
      <div className="flex h-[140px] flex-col justify-between p-4">
        <div className="flex flex-col gap-2">
          ...
          <p className="line-clamp-2 text-body_medium_14 text-gray10">{contents}</p>
        </div>
